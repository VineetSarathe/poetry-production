...
//           {/* WELCOME */}
//           <div className="bg-white rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.10)] p-6 sm:p-8">
//             <h2 className="text-2xl sm:text-3xl font-bold text-[#5b1919] mb-3">
//               {lang === "en"
//                 ? "Welcome to Gahraaiyan"
//                 : "Gahraaiyan में आपका स्वागत है"}
...
//             <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
//               {lang === "en"
//                 ? "Where silence turns into verses, and emotions find their voice through poetry and shayari."
//                 : "जहाँ ख़ामोशी अल्फ़ाज़ बनती है, और एहसास कविता व शायरी में अपनी आवाज़ पाते हैं।"}
//             </p>
//           </div>

//           {/* QUOTE */}
//           <div className="bg-gradient-to-br from-[#5b1919] to-[#7a2b2b] text-white rounded-3xl shadow-[0_20px_60px_rgba(91,25,25,0.35)] p-6 sm:p-8 flex flex-col justify-center">
//             <p className="text-sm uppercase tracking-widest opacity-70 mb-2">
//               {lang === "en" ? "Quote of the Day" : "आज का विचार"}
//             </p>
...
//             <p className="italic text-lg sm:text-xl leading-relaxed">
//               {lang === "en"
//                 ? "“Some feelings are too heavy for words — they become poetry.”"
//                 : "“कुछ एहसास अल्फ़ाज़ों में नहीं समाते — वो कविता बन जाते हैं।”"}
//             </p>
//           </div>
...
//       {/* ================= SEPARATOR ================= */}
//       <div className="max-w-5xl mx-auto my-10 h-[1px] bg-gradient-to-r from-transparent via-[#5b1919]/30 to-transparent" />

//       {/* ================= EMOTIONS ================= */}
//       <section className="px-4 pb-10">
//         <h3 className="text-xl sm:text-2xl font-bold text-center text-[#5b1919] mb-6">
//           {lang === "en" ? "Explore Emotions" : "एहसासों का सफ़र"}
//         </h3>

//         <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-5xl mx-auto">
//           {[
//             { en: "Love", hi: "मोहब्बत", emoji: "❤️" },
//             { en: "Pain", hi: "दर्द", emoji: "💔" },
//             { en: "Hope", hi: "उम्मीद", emoji: "✨" },
//             { en: "Dreams", hi: "ख़्वाब", emoji: "🌙" }
//           ].map((item, i) => (
//             <Link
//               key={i}
//               to="/poems"
//               className="bg-white p-5 rounded-2xl shadow-sm text-center hover:shadow-xl hover:-translate-y-1 hover:scale-[1.03] transition-all duration-300 block"
//             >
//               <div className="text-2xl mb-1">{item.emoji}</div>
...
//       {/* ================= FEATURE STRIP ================= */}
//       <section className="bg-[#5b1919] text-white py-10 mt-6">
//         <div className="max-w-4xl mx-auto text-center px-4">
...
//           <p className="text-sm sm:text-base opacity-90 leading-relaxed">
//             {lang === "en"
//               ? "Some emotions whisper, not speak — poetry listens."
//               : "कुछ एहसास बोलते नहीं… कविता उन्हें सुनती है।"}
//           </p>
